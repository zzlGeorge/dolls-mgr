        ...
        .bootstrapTable(
            {
                ...
                url: prefix + "/listMagicBox", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize: 'outline',
                ...
                onExpandRow: function (index, row, $detail) {
                    ...
                    magicRuleTb($el, prefix + '/list', row['bizId']);
                },
                columns: [
                    {
                        checkbox: true
                    ...
                    },
                    {
                        ...
                        formatter:function (value, row, index) {
                            return value<9?'规则不够，只有<font size="5" face="arial" color="red">'+value+'</font>个':value;
                        }
                    },
                    {
                        field: 'img',
...
function magicRuleTb($tb, url, boxId) {
    $tb.bootstrapTable(
        {
            method: 'get', // 服务器数据的请求方式 get or post
            url: url, // 服务器数据的加载地址
